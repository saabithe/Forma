...
export default function SkillDetail({ skillId, app, onBack }) {
  const { state, addActiveSkill, removeActiveSkill, getSkillTrainingInfo } = app
  ...
  // Get level-up criteria progress
      ...
      <div className="flex gap-3">
        {isActive ? (
          <button
            ...
            className="flex-1 py-3 rounded-xl glass text-muted font-medium hover:bg-gray-100 transition-colors text-sm"
          >
            Pause Training
          </button>
        ) : isMastered ? (
